...
assert(env.isRecentOrderFilter("months-3") == true, "months-3 recent when scanMonths unlimited")
assert(env.isRecentOrderFilter("months-3", 1) == false, "months-3 not forced for 1-month incremental")
...
assert(env.isRecentOrderFilter("Letzte 3.Monate", 1) == false, "Business DE 3 months not forced at 1 month")
